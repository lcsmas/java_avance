...
public class Appartement implements Cloneable, Serializable {
	...
	public String feuilleLoyer() {
		return "adresse = " + this.adresse + " val loc base = " + this.valLocBase() + " coeff moderateur = "
				+ this.coeffModerateur() + " loyer = " + this.loyer();
	}

	private void saisie(Scanner sc) {
		System.out.println("Entrer l'adresse");
		adresse = sc.next();
		System.out.println("Entrer l'annee de construction");
		anneeConstruction = sc.nextInt();
		System.out.println("Entrer le nombre de pieces");
		nbPieces = sc.nextInt();
